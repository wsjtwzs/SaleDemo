...
static NSString *NAVBUTTON_exit_h = @"nav_exit_h";
...
static NSString *NAVBUTTON_save = @"nav_save";
static NSString *NAVBUTTON_save_h = @"nav_save";
...
@property (nonatomic ,assign) LoginPerson loginPerson;
