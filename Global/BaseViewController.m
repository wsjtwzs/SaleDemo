...
{
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"common_bg_ios7"]];
    if (!self.dataArray) {
...
- (UIBarButtonItem *) barButtonItemWithBarItemType:(MoshNavigationBarItemType)type isLeft:(BOOL)isLeft
{
    switch (type) {
        ...
        case MoshNavigationBarItemAdd:
            ...
            break;
        case MoshNavigationBarItemSave:
            return [BaseViewController createNavigationBarItemWithNormalImageName:NAVBUTTON_save highlightImageName:NAVBUTTON_save_h title:nil isLeft:isLeft action:@selector(navSaveClick)target:self];
            break;
